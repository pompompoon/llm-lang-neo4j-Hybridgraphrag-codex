...
def train_graphsage(
    ...
    # Hold out validation/test edges instead of evaluating on training edges.
    ...
    train_data, _val_data, test_data = splitter(data)
    ...
    with torch.no_grad():
        ...
        scores = model.predict_link(z, test_data.edge_label_index).sigmoid()
